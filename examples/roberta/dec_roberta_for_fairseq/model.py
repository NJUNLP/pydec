...
@register_model_architecture("dec_roberta", "dec_roberta")
...
@register_model_architecture("dec_roberta", "dec_roberta_prenorm")
...
@register_model_architecture("dec_roberta", "dec_roberta_base")
def roberta_base_architecture(args):
    base_architecture(args)


@register_model_architecture("dec_roberta", "dec_roberta_large")
...
@register_model_architecture("dec_roberta", "dec_xlm")
